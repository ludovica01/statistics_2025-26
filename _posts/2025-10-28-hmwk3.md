...
The experiment was executed on Google Colab: I encrypted a short text, applied two decryption methods (factorization and frequency analysis), and saved visual results for publication.
...
<ul>
  ...
  <li>For the website, only the plots and decrypted text image were included. The code was executed in Google Colab, and all images were saved in the <code>css/images</code> folder.</li>
</ul>

<h2>Files and References</h2>

<ul>
  <li>Colab scripts: <code>method_a.py</code> and <code>method_b.py</code> (can be shared in a <code>scripts/</code> folder for reproducibility).</li>
  <li>Generated images stored in <code>css/images/</code> with filenames: <code>rsa_plain_freq.png</code>, <code>rsa_cipher_freq.png</code>, and <code>rsa_decrypted_text.png</code>.</li>
</ul>
