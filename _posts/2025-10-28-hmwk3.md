...
<ul>
    <li><img src="{{ site.baseurl }}//assets/images/plain_freq.jpg" alt="Plaintext Frequencies">
    <li><img src="{{ site.baseurl }}//assets/images/cipher_freq.jpg" alt="Encrypted Frequencies">
</ul>
