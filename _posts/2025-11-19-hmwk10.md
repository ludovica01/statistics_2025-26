...
<img src="{{ site.baseurl }}/assets/images/hmwk10-bayesian-curve" alt="Bayesian Curve" class="center-image">
...
<p> This experiment illustrates the frequentist interpretation: the empirical relative frequency converges to the true probability as the number of trials increases. </p> <h3>Bayesian Update with a Beta Prior</h3>
